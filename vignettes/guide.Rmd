...
* num_reps - the number of replicates for the experimental conditions. It should
match the number of files for each condition, otherwise file input will not
function properly (you will get a specific error).
